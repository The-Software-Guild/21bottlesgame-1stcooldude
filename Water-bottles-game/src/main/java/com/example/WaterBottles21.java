...
public class WaterBottles21 {
	...
	public int isInputNumberValid() {
		...
		// 1. Write the Java Code to accept the valid number of bottles user wants to
		// pick.
		// 2. Use the Instance variable "scanner" to accept the input from the user.
		// 3. In case of valid input, return back the number.
		// 4. To print on console, use this.printStream.print() and NOT the
		// System.out.println()
		// 5. In case of invalid input, print on console exactly as below :-
		// "As per the Game Rules, please pick up bottles between 1 and 4 only, both
		// inclusive".
		// and return back -1
	...
	public void printGameRules() {
		// To print on console, use this.printStream.print() and NOT the
		// System.out.println()
		// and using the this.printStream.print(), print below contents on console
		// exactly as below
